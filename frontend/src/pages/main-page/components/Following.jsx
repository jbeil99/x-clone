...
const Following = () => {
    const { loading, error, followingTweets, nextPageUrl, hasMore } = useSelector((state) => state.tweets);
    const dispatch = useDispatch();

    const loadMoreTweets = () => {
        console.log("hi", loading, hasMore, nextPageUrl)
    ...
    return (
        <div className="divide-y divide-gray-200 dark:divide-gray-800">
            ...
            {loading && followingTweets.length === 0 && (
                <div className="py-4 flex justify-center items-center">
